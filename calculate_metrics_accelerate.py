...
if __name__ == '__main__':
    ...
    parser.add_argument("--ref_scp", type=str, default="data/nonblind/spk1.scp")
    parser.add_argument("--ref_text", type=str, default="data/nonblind/text")
    parser.add_argument("--utt2lang", type=str, default="data/nonblind/utt2lang")
